...
void log_printf(const char*function_name,const char*format,...){
	...
	time(&time0);
	lt= *localtime(&time0);
	sprintf(logentry,"%02u%02u%02u %02u:%02u:%02u.%03d ", lt.tm_year-100,lt.tm_mon+1,lt.tm_mday, lt.tm_hour,lt.tm_min,lt.tm_sec,tv.tv_usec/1000);
...
//#line 1178 "./sgfilter.w"
	...
	//for(k= 1;k<=mm;k++)fprintf(stdout,"%1.8f \n",yf[k]); 
#ifdef UNIX_LIKE_OS
