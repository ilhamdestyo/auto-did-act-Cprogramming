...
int datainput_1[99999],datainput_2[99999],datainput_3[99999], datainput_4[99999], datainput_5[99999]; // array integer dengan elemen sebanyak 99999 baris
int number_data;
 ...
 *dibuat 5 variable data raw sebagai data input
 */ 
void get_data_from_rawdata(){
	char datain1[100],datain2[100],datain3[100],datain4[100],datain5[100];
	for(int i=1;i<number_data+1;i++){
		txtResult = replaceWordInString(dataraw[i],","," ");
		sscanf(txtResult,"%s  %s  %s  %s  %s",datain1,datain2,datain3,datain4,datain5);
...
/*
 * Fungsi menyimpan program ke dalam file.txt baru
 */
