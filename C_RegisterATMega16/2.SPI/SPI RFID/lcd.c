...
{
//Send byte ke LCD pada 4bit mode
//cmd=0 untuk data
//cmd=1 untuk command

uint8_t hn,ln;//nibble
uint8_t temp;
...
delay_us(5);			//tEH   new setting

//Now data lines are stable pull E low for transmission

CLEAR_E();

delay_us(5);       // new setting
...
delay_us(5);			//tEH   new settimng

//SEND

CLEAR_E();

delay_us(5);			//tEL new setting
...
void LCDInit(uint8_t style)
{
	...
	Fungsi Inisialisasi LCD Module
	Arguments:
