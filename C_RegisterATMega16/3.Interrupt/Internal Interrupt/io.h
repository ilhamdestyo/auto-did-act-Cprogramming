...
/*Pengaturan Fungsi pada ATmega16*/
...
#define _SFR_IO8(io_addr) _MMIO_BYTE((io_addr) + __OFFSET)
#define _SFR_IO16(io_addr) _MMIO_WORD((io_addr) + __OFFSET)
//converts the I/O address to the memory address
...
#define CS00    0 // register untuk timer yang digunakan
#define CS01    1
#define CS02    2 // register untuk timer yang digunakan
#define WGM01   3
#define COM00   4
#define COM01   5
#define WGM00   6
...
#define ISC00   0 //register yang digunakan 
#define ISC01   1 //register yang digunakan
#define ISC10   2
#define ISC11   3
#define SM0     4
#define SM1     5
...
#define TOIE0   0 // >> register timer yang digunakan
#define OCIE0   1
#define TOIE1   2
#define OCIE1B  3
#define OCIE1A  4
...
#define IVSEL   1
#define INT2    5
#define INT0    6 //register interrupt 0 yang digunakan
#define INT1    7
...
#define INT0_vect_num			1 //external interrupt request yang di enable untuk melakukan interupsi
...
#define TIMER0_OVF_vect_num		9 //enable timer 0 untuk internal interrupt
...
//special function
#define BV(bit)                     (1<<(bit))           //shift bit 
#define setbit(byte, bit)			(byte |= BV(bit))    //set target bit on register 
#define clearbit(byte, bit)         (byte &= ~BV(bit))   //clearing targer bit on register
#define toggle(byte, bit)			(byte ^= BV(bit))    //toggle function 
#define bitisClear(byte, bit)       (!(byte & BV(bit)))  //check if target bit is 0
#define bitisSet(byte, bit)         (byte & BV(bit))     //check if target bit is 1
#define setoutput(byte, bit)        (byte |= BV(bit))    //set DDRx as Output 
#define setinput(byte, bit)         (byte &= ~BV(bit))   //set DDRx as Input 
