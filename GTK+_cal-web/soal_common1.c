...
#include <gtk/gtk.h>
	...
	extern const gchar *entry_text1;
    extern const gchar *entry_text2;
...
//Declare enum
enum state{F = 0, T = 1};//penggunaan value 0 untuk menunjukkan FALSE dan value 1 untuk menunjukkan TRUE
...
/*=======================================================Calendar Template====================================================================*/
int calendar(int yearinput, int monthinput){
